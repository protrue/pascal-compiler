...
namespace PascalCompiler.Constants
{
    ...
    {
        public static Dictionary<int, string> ErrorsMap = new Dictionary<int, string>()
        {
            ...
            { 1001, @"Должна идти операция отношения"},
            { 1002, @"Должна идти аддитивная операция"},
            { 1003, @"Должна идти мультипликативная операция"},
            { 1004, @"Должно идти выражение"},
            ...
            { 1011, @"Должна идти переменная"},
            { 1012, @"недопустимые типы операндов" },
        };
    }
}